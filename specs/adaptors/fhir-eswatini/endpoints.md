# FHIR Eswatini Client Registry API (OpenFn fhir-eswatini subset) (fhir-eswatini) v4.0.1

<!-- derived from openapi.json by `pnpm specs index fhir-eswatini` — do not edit by hand -->

base: http://172.209.216.154:3447/fhir | auth: not declared | 31 operations in 7 resources
