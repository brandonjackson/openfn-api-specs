# HL7 FHIR R4 REST API (OpenFn fhir-4 subset) (fhir-4) v4.0.1

<!-- derived from openapi.json by `pnpm specs index fhir-4` — do not edit by hand -->

base: https://hapi.fhir.org/baseR4 | auth: not declared | 31 operations in 7 resources
