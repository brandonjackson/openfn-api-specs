# FHIR France (FR Core) R4 REST API (OpenFn fhir-fr subset) (fhir-fr) v4.0.1

<!-- derived from openapi.json by `pnpm specs index fhir-fr` — do not edit by hand -->

base: https://fhir.example.fr/fhir | auth: not declared | 31 operations in 7 resources
